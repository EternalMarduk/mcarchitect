...
public class SchematicReader {
    ...
    /**
     * checks if any single block could not be read, as that does not throw the parse exception (instead the faulty
     * block gets replaced by air)
     * 
     ...
     */
    public static SliceStack readSchematicsFile(File f) throws IOException, ClassicNotSupportedException,
            ParseException {
        ...
        try {
            ...
            // substituting letters for blocks, that means the array [a, b, c, d, e, f, g, h] would result in two slices
            // like the following ones (assuming
            ...
            for (int slz = 0; slz < height; ++slz) {
                ...
                for (int y = 0; y < width; ++y) { // height of slice
                    for (int x = 0; x < length; ++x) { // width of slice
                        ...
                        // &0xFF is because the array uses unsigned bytes while java uses signed ones. it converts
                        // values like -127 back to values like 129
                            ...
                            if (blockid == 54 || blockid == 146 || blockid == 23 || blockid == 154 || blockid == 158) {
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (((blockid == 54 || blockid == 146) && !tagId.equals("Chest"))
                                        ...
                                        throw new ParseException("Contains a container, id " + blockid
                                                + " that has a wrong tile entity of type " + tagId);
                                    }
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Music")) {
                                        throw new ParseException(
                                                "Contains a note block that has a tile entity of type "
                                                        + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                        + tileEntity.toString());
                                    }
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Sign")) {
                                        throw new ParseException("Contains a sign that has a tile entity of type "
                                                + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                + tileEntity.toString());
                                    }
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Cauldron")) {
                                        throw new ParseException(
                                                "Contains a brewing stand that has a tile entity of type "
                                                        + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                        + tileEntity.toString());
                                    }
                                    ...
                                    // brewing time is defined as being IntTag, but some schematic files fly around in
                                    // which it is ShortTag
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Control")) {
                                        throw new ParseException(
                                                "Contains a command block that has a tile entity of type "
                                                        + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                        + tileEntity.toString());
                                    }
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Beacon")) {
                                        throw new ParseException("Contains a beacon that has a tile entity of type "
                                                + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                + tileEntity.toString());
                                    }
                                ...
                                if (tileEntity == null) {
                                    ...
                                    if (!((StringTag) tileEntity.get("id")).getValue().equals("Skull")) {
                                        throw new ParseException("Contains a mob head that has a tile entity of type "
                                                + ((StringTag) tileEntity.get("id")).getValue() + ":\n"
                                                + tileEntity.toString());
                                    }
    ...
    private static void addItemToListFromCompound(Item[] items, CompoundTag itemTag) {
        ...
        // add special tag info - null check everywhere because older MC versions (and therefore older schematics) may
        // not have had a tag-tag
