...
public class Potion extends Item {
    ...
    /**
     * @param potionName The name of the potion. Must be exact and not include "Splash", or else a water bottle/mundane
     *            potion is generated. See ItemPotion.potionNames
     */
    ...
    /**
     * @param base true to get the base duration value in seconds, false to get the real one (with tier and ext.
     *            duration)
     * @return the duration
     */
