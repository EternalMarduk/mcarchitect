...
public class ImageGridStack implements Printable {
     ...
     * 
     * @param grids the ImageGrids. It is assumed that all grids in this array are of the same zoom value and grid line
     *            color
     */
    ...
    public void setGridAtLevel(int level, ImageGrid grid) {
        ...
        } else if (grid.getZoom() != this.zoom || grid.getGridColor() != this.gridColor
                || grid.getMarkColor() != this.markColor) {
            throw new IllegalArgumentException(
                    "new grid not of same gridcolor, markcolor or zoom as the rest of the grids");
        }
