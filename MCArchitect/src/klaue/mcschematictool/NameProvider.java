...
public class NameProvider {
    /**
     * This method provides the name of the given block/item id and data It only provides the name of the block itself,
     * so giving the data value for, for example, rails makes no sense as the rails data contains directional
     * information - if you need this too, get an instance per Block.getInstance() and read that instances toString()
     * 
     * @param id the id of the block
     * @param data the data of the block or -1 if it doesn't matter for the block name (or the default value like white
     *            wool for wool)
