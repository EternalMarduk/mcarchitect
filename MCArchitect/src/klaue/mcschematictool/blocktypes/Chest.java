...
public class Chest extends Block {
    /**
     * An array of exactly 27 items corresponding to the 27 slots of a chest. Empty slots are Items with data = 0
     */
    ...
    /**
     * Initializes the (untrapped) chest. The new chest will contain exactly 27 items, some or all of which may be zero
     * (empty)
     * 
