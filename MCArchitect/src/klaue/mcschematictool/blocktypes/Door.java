...
public class Door extends DirectionalBlock {
     ...
     * @param isOpen true if this door has swung counterclockwise around its hinge. (this is actually closed for the
     *            "wrong" half of a double door)
    ...
    /**
     * Returns true if this door is open (swung counterclockwise around its hinge - closed for the "wrong" site of a
     * double door)
     * 
     * @return true if open
     */
    ...
    /**
     * Set to true if this door is open (swung counterclockwise around its hinge - closed for the "wrong" site of a
     * double door)
     * 
