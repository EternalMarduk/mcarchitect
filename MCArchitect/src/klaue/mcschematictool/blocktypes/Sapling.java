...
public class Sapling extends Block {
    ...
    /**
     * Get the growth value of the sapling. Growth 0 is a newly planted one, growth 15 (0xF) is one that will convert to
     * a tree
     * 
     * @return the growth
     */
    ...
    /**
     * Set the growth value of the sapling. Strength 0 is a newly planted one, strength 3 is one that will convert to a
     * tree
     * 
