...
public class TripwireHook extends DirectionalBlock {
    ...
    public String toString() {
        return super.toString() + " (" + (this.isConnected ? "connected" : "not connected") + ", "
                + (this.isActivated ? "activated" : "not activated") + "), direction: " + this.direction;
    }
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        // flip directions because they say where the lever is facing, but to show the wall it's attached to makes more
        // sense
        Direction direction;
        switch (this.direction) {
            case N:
