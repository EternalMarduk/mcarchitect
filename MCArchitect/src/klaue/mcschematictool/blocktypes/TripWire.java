...
public class TripWire extends Block {
    ...
    // first booelan is line (true) or "cross" (false). when not called by Slice, line defaults to true and direction to
    // E
    private static HashMap<Boolean, HashMap<Direction, BufferedImage>> directionalWireImageCache = new HashMap<Boolean, HashMap<Direction, BufferedImage>>();
    ...
    /**
     * Sets this wires trigger state. Trigger means there's something on this wire (this wire was responsible for
     * activating the rest of the wire)
     * 
    ...
    public String toString() {
        return super.toString() + " (" + (this.isActivated ? "activated" : "not activated") + ", "
    ...
    /**
     * Sets the type of the wire. Since the direction of a tripwire is not saved into the block data, this should be
     * called once the wires neighbors are known, see param direction
     * 
    ...
    /**
     * Sets the type of the wire. Since the direction of a tripwire is not saved into the block data, this should be
     * called once the wires neighbors are known, see boolean params
     * 
