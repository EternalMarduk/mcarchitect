...
public class Cactus extends Block {
    ...
    /**
     * Get the growth value of the cactus. growth 0 is a newly planted one, growth 15 (0xF) is one that will spawn a new
     * block atop of it
     * 
     * @return the growth
     */
    ...
    /**
     * Set the growth value of the cactus. Strength 0 is a newly planted one, strength 15 (0xF) is one that will spawn a
     * new block atop of it
     * 
