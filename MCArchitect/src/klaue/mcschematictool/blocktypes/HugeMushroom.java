...
/**
 * Vines can have different directions (walls they're attached to). A Vine block can be attached to multiple sides at
 * once
 * 
 * @author klaue
 * 
...
public class HugeMushroom extends MultiDirectionalBlock {
    ...
    public enum HugeMushroomType {
        /** Huge red mushroom */
        RED, /** Huge brown mushroom */
        BROWN
    }

    /**
     * Type of the mushroom-block (internally used for caching of the image representation)
     * 
     * @author klaue
     */
    public enum HugeMushroomBlockType {
        /** a hood piece of the mushroom type */
        HOOD("hood piece"), /** a stem piece */
        STEM("stem piece"), /** an internal piece */
        FLESH("flesh piece");
    ...
    private static HashMap<HugeMushroomType, HashMap<HugeMushroomBlockType, HashMap<Byte, BufferedImage>>> hugeMushroomImageCache = new HashMap<HugeMushroomType, HashMap<HugeMushroomBlockType, HashMap<Byte, BufferedImage>>>();
     ...
     * @param directions the directions in which the hood texture is used (leave it null if this is a stem or flesh
     *            block)
     */
    ...
    public String getToolTipText() {
        /*
         * if (this.blockType == HugeMushroomBlockType.STEM || this.blockType == HugeMushroomBlockType.FLESH) { return
         * this.toString(); } return super.toString() + ", hood piece";
         */
     ...
     * 
     * @param directions valid directions are either any of N, E, S or W, or just TOP. Note that the array should not
     *            have duplicates in it.
     */
    @Override
