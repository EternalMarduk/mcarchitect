...
public class Button extends DirectionalBlock {
     ...
     * @param isPressed true if this button is pressed (should not be set manually because the button will never
     *            depress)
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        if (buttonZoomCache != zoom) {
            ...
            if (buttonImageCache.containsKey(this.id) && buttonImageCache.get(this.id).containsKey(this.direction)) {
        ...
        // flip directions because they say where the button is facing, but to show the wall it's attached to makes more
        // sense
        Direction direction;
        switch (this.direction) {
            case N:
