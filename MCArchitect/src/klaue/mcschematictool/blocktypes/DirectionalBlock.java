...
public abstract class DirectionalBlock extends Block {
    ...
    public enum Direction {
        ...
        UP, /** Down */
        DOWN, /** North */
        N("north"), /** Northnortheast */
        NNE("north north east"), /** Northeast */
        NE("north east"),
        /** Eastnortheast */
        ENE("east north east"), /** East */
        E("east"), /** Eastsoutheast */
        ESE("east south east"), /** Southeast */
        SE("south east"),
        /** Southsoutheast */
        SSE("south south east"), /** South */
        S("south"), /** Southsouthwest */
        SSW("south south west"), /** Southwest */
        SW("south west"),
        /** Westsouthwest */
        WSW("west south west"), /** West */
        W("west"), /** Westnorthwest */
        WNW("west north west"), /** Northwest */
        NW("north west"),
        /** Northnorthwest */
    ...
    private static final int[] nArrow = { tpr, tpr, red, red, tpr, tpr, tpr, red, red, red, red, tpr, red, red, red,
            red, red, red };

    private static final int[] neArrow = { red, red, red, red, tpr, red, red, red, tpr, tpr, red, red, tpr, tpr, tpr,
            red };

    private static final int[] eArrow = { red, tpr, tpr, red, red, tpr, red, red, red, red, red, red, red, red, tpr,
            red, tpr, tpr };

    private static final int[] seArrow = { tpr, tpr, tpr, red, tpr, tpr, red, red, tpr, red, red, red, red, red, red,
            red };

    private static final int[] sArrow = { red, red, red, red, red, red, tpr, red, red, red, red, tpr, tpr, tpr, red,
            red, tpr, tpr };

    private static final int[] swArrow = { red, tpr, tpr, tpr, red, red, tpr, tpr, red, red, red, tpr, red, red, red,
            red };

    private static final int[] wArrow = { tpr, tpr, red, tpr, red, red, red, red, red, red, red, red, tpr, red, red,
            tpr, tpr, red };

    private static final int[] nwArrow = { red, red, red, red, red, red, red, tpr, red, red, tpr, tpr, red, tpr, tpr,
            tpr };
    ...
    /**
     * returns the direction this block faces or the direction of the block this block is attached to, depending on the
     * type of block
     * 
    ...
    /**
     * sets the direction this block faces or the direction of the block this block is attached to, depending on the
     * type of block
     * 
     * @param direction
     */
    ...
    /**
     * Adds a red arrow to the image, pointing in the given direction. If the direction is not in the 45° range, two
     * arrows will be used to show the direction, for example, NNW will have an arrow pointing to north and one pointing
     * to NW. A new image instance will be returned, the original image will not be changed. Note: Currently there will
     * be no arrow for UP and DOWN
     * 
