...
public class Lever extends DirectionalBlock {
    ...
    public String toString() {
        return super.toString() + " (" + (this.isThrown ? "on" : "off") + "), on "
                + (this.isOnGround ? "ground" : (this.isOnCeiling ? "ceiling" : "wall")) + ", direction: "
                + this.direction;
    }
    ...
    public synchronized BufferedImage getImage(double zoom) {
        ...
        if (this.isOnGround || this.isOnCeiling) {
            ...
            // flip directions because they say where the lever is facing, but to show the wall it's attached to makes
            // more sense
            Direction direction;
            switch (this.direction) {
                case N:
