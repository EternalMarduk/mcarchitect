...
public class Block {
    ...
    public enum Type {
        ...
        JACKOLANTERN, /** Cake */
        CAKE, /** Beds */
        BED, /** Redstone repeaters */
        REDSTONE_REPEATER,
        /** Juke boxes */
        JUKEBOX, /** Redstone wires */
        REDSTONE_WIRE, /** Tall Grass */
        TALL_GRASS, /** Trap Door */
        TRAP_DOOR,
        /** Stem */
        STEM, /** Vines */
        VINES, /** Fence gate */
        FENCEGATE, /** Cauldron */
        CAULDRON, /** Nether Wart */
        NETHERWART,
        /** Frame of the end portal */
        ENDPORTALFRAME, /** Brewing Stand */
        BREWINGSTAND, /** Redstone lamp */
        REDSTONELAMP,
        /** Sandstone */
        SANDSTONE, /** Wooden plank */
        WOODENPLANK, /** Cocoa pod */
        COCOAPOD, /** Tripwire */
        TRIPWIRE,
        /** Tripwire hook */
        TRIPWIREHOOK, /** Ender chest */
        ENDERCHEST, /** Command Block */
        COMMANDBLOCK, /** Beacon */
        BEACON,
        /** anvil */
        ANVIL, /** flower pot */
        FLOWERPOT, /** cobble wall */
        COBBLESTONEWALL, /** mob heads */
        MOBHEAD,
        /** activator rail */
        ACTIVATOR_RAIL, /** dropper */
        DROPPER, /** hopper */
        HOPPER, /** block of quartz */
        QUARTZBLOCK,
        /** snow cover */
        SNOWCOVER
    };
    ...
    /**
     * Generates a new air block If you want a block other than air, use Block.getInstance() to ensure the right subtype
     */
    public Block() {
        this((byte) 0, (byte) 0);
    }
    ...
    public static Block getInstance(short id, byte data) {
        switch (id) {
            ...
            case 143:
                return new Button(id, data);
            case 144:
                return new MobHead((byte) 3, (byte) 8, null, data); // north facing human head - most data from tile
                                                                    // entity
            case 145:
    ...
    /**
     * Get the additional block data. It's generally a better idea to figure out the block type and using the getters of
     * the specific subclass instead of decoding the data value yourself
     * 
    ...
    /**
     * Sets the raw data value. It's generally a better idea to figure out the block type and using the setters of the
     * specific subclass instead of encoding the data value yourself
     * 
    ...
    /**
     * Returns a new BufferedImage representing the block Warning: Block caches images by ID and ID only. If the block
     * changes looks by data value, make a subclass
     * 
