...
public abstract class MultiDirectionalBlock extends Block {
    ...
    /**
     * returns the directions this block faces or the directions of the blocks this block is attached to, depending on
     * the type of block
     * 
    ...
    /**
     * sets the directions this block faces or the directions of the block this block is attached to, depending on the
     * type of block
     * 
     * @param directions
     */
    ...
    /**
     * Adds red arrows to the image, pointing in all the given directions. If one direction is not in the 45° range,
     * two arrows will be used to show the direction, for example, NNW will have an arrow pointing to north and one
     * pointing to NW. A new image instance will be returned, the original image will not be changed.
     * 
