...
public class StoneSlab extends Block {
    ...
    public enum SlabType {
        /** Stone Slab */
        STONE, /** Sandstone Slab */
        SANDSTONE,
        /** Wooden stone Slab */
        WOOD, /** Cobblestone Slab */
        COBBLESTONE,
        /** Brick Slab */
        BRICK, /** Stone Brick Slab */
        STONEBRICK,
        /** nether brick */
        NETHERBRICK, /** quartz */
        QUARTZ,
        /** smooth stone */
        SMOOTHSTONE, /** smooth sandstone */
        SMOOTHSANDSTONE,
        /** tile quartz */
        TILEQUARTZ
    }
    ...
    public StoneSlab(boolean isDoubleSlab, boolean isUpperHalf, SlabType slabType) {
        ...
        if (!isDoubleSlab) {
            if (slabType == SlabType.SMOOTHSTONE || slabType == SlabType.SMOOTHSANDSTONE
                    || slabType == SlabType.TILEQUARTZ) {
