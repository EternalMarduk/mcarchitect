...
public class BrewingStand extends MultiDirectionalBlock {
    ...
    /**
     * An array of exactly 3 items corresponding to the 3 slots of a brewing stand. Empty slots are Items with data = 0
     */
    ...
    public BrewingStand(byte direction, Item[] content, int brewingTime) {
        ...
        if (content == null || content.length == 0) {
            ...
            throw new IllegalArgumentException(
                    "Brewing stands can only have up to 3 items and 1 result (4 items in total)");
        } else if (content.length == 4) {
    ...
    public String getToolTipText() {
        StringBuffer sb = new StringBuffer("<html><body>Brewing stand, brewing time: ").append(this.brewingTime)
                .append(", contents:<br>");
            ...
            for (Direction dir : directions) {
                switch (dir) {
                    ...
                    case SW:
                        ...
                        break; // 100
                    default:
                        throw new IllegalArgumentException("illegal direction " + dir + " in direction array "
                                + directions);
                }
            }
        }
    ...
    public JToolTip getCustomToolTip() {
        ...
        for (int i = 0; i < this.content.length; ++i) {
            ...
            if (amount > 1) {
                ...
                if (text.length == 2) {
                    g.drawImage(shadow[0], p.x + 6, p.y + 10, 8, 8, null, null); // overlaps 1px over the item icon
                                                                                 // frame
